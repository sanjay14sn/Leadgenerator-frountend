...
const MetricCard = ({ title, value, icon }) => (
  <div className={`p-5 rounded-xl border border-gray-200 shadow-sm bg-white hover:shadow-md transition duration-150`}>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex items-center gap-4">
            {/* Notification Button */}
            <button className="relative p-2 text-white rounded-full hover:bg-teal-600 transition" title="Notifications">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.16 6 8.356 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
            </button>
            ...
            <div className="flex items-center gap-2 border-l border-teal-600 pl-4">
                <div className="flex items-center gap-2">
                    ...
                    <div className="h-10 w-10 rounded-full bg-white flex items-center justify-center text-sm text-[#1ABC9C] font-bold shadow-md">AU</div>
                    {/* Hidden on small screens */}
                    <span className="hidden md:inline text-sm font-medium text-white">Admin User</span>
                </div>
                <button
                    onClick={() => {
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-[120px] left-0 right-0 bg-white shadow-xl z-20 md:hidden p-4 border-b">
            ...
            <p className="text-sm text-gray-600">Mobile Navigation placeholder...</p>
        </div>
      )}
      ...
      >
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
                <p className="text-sm text-gray-500 mb-1">IQSync / {currentTitle}</p>
            ...
            <div className="bg-white p-6 rounded-xl shadow mb-10 border border-gray-200">
                <h2 className="text-xl font-semibold text-gray-800 mb-4">Quick Lead Scraper</h2>
            ...
            <div className="bg-white p-6 rounded-xl shadow border border-gray-200">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-semibold text-gray-800">Today’s Leads</h2>
